...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.7402*2,78.7402*2,6667.184,760*1.0}  // default steps per unit for ultimaker 
#define DEFAULT_MAX_FEEDRATE          {500, 500, 0.4, 45}   // (mm/sec)    
